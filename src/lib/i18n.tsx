...
const dict = {
  en: {
    ...
    stageLearning: "Stage 3 · Learning",
    concept: "Concept",
  ...
  ru: {
    ...
    practiceFlashcards: "Практика с карточками",
    preparingLesson: "Готовим урок...",
    stageLearning: "Этап 3 · Обучение",
    concept: "Понятие",
    inSimpleWords: "Простыми словами",
    realLifeExample: "Пример из жизни",
    keyTakeaway: "Главный вывод",
    simpleDefinition: "Простое определение",
    expandedExplanation: "Расширенное объяснение",
  ...
  kk: {
    ...
    practiceFlashcards: "Карточкалармен практика",
    preparingLesson: "Сабақ дайындалып жатыр...",
    stageLearning: "3-кезең · Оқу",
    concept: "Ұғым",
    inSimpleWords: "Қарапайым сөзбен",
    realLifeExample: "Өмірлік мысал",
    keyTakeaway: "Негізгі қорытынды",
    simpleDefinition: "Қарапайым анықтама",
    expandedExplanation: "Кеңейтілген түсіндіру",
