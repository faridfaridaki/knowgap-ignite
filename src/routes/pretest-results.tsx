...
function PreTestResults() {
  ...
  useEffect(() => {
    ...
    const score = scoreTest(s.preTestQuestions, s.preTestAnswers);
      ...
      <div className="mx-auto w-full max-w-[720px]">
        <div className="text-center mb-10">
          ...
          <h1 className="mt-4 text-3xl sm:text-4xl font-bold text-foreground">
            You got {state.preTestScore} out of {total} correct
          </h1>
          <p className="mt-2 text-sm text-muted-foreground">
            Don't worry — that's exactly what we're going to fix.
          </p>
